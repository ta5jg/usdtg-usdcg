...
CONTRACT_ADDRESS = "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t"  # TRON TRC20 örneği
...
def main():
    ...
    with open('tron_addresses.txt', 'w') as f_txt, open('tron_addresses.csv', 'w', newline='') as f_csv:
